    ...
    bool skipShadowMap)
{
    ...
    __declspec(align(16)) struct
    {
        ...
        uint32_t diffuseGIEnabled; // 1 = sample env cubemap as diffuse irradiance
        float    _pad[1];
    } psConstants;
    ...
    psConstants.diffuseGIEnabled  = m_DiffuseGIEnabled;
    psConstants._pad[0] = 0.0f;
